...
class NewsViewPage extends StatefulWidget {
  final News newsPost;
  NewsViewPage({Key? key, required this.newsPost}) : super(key: key);
  @override
                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                image:
                                    NetworkImage(widget.newsPost.sourceImage),
                              ),
                            ),
                          ),
                          Expanded(
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Text(
                                    widget.newsPost.source,
                                    style: TextStyle(
                                        color: Colors.white,
                                        fontWeight: FontWeight.bold),
                                  ),
                                  Text(
                                    widget.newsPost.time,
                      ...
                      Container(
                        margin: EdgeInsets.only(top: 10, right: 40),
                        child: Text(widget.newsPost.descrption,
                            style: TextStyle(
                              color: Colors.white,
                            )),
                      )
